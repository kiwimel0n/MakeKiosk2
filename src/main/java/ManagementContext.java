...
public class ManagementContext {
    ...
    public void addCartToOrder(int orderNumber, String message, List<Product> cart, Double totalPrice) {
        List<Product> orderProductList = new ArrayList<>(cart);
        orderList.add(new Order(orderNumber, message, orderProductList, totalPrice));
    }
    ...
    public void deleteMenuItems(Map<String, List<Product>> menuProducts, int itemId) {
